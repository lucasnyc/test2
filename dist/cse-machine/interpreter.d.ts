 ...
 */
export declare function evaluate(code: string, program: es.Program, context: Context, options?: RecursivePartial<IOptions>): Value;
/**
 ...
 */
export declare function generateCSEMachineStateStream(code: string, context: Context, control: Control, stash: Stash, envSteps: number, stepLimit: number, isPrelude?: boolean): Generator<{
    stash: Stash;
    control: Control;
    steps: number;
}, void, unknown>;
