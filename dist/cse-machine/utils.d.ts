...
export declare const checkNumberOfArguments: (source: string, command: ControlItem, context: Context, callee: Closure | Value, args: Value[], exp: es.CallExpression) => undefined;
